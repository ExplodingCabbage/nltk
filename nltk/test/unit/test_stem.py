...
class PorterTest(unittest.TestCase):
    ...
    _files_folder = os.path.join(os.path.dirname(__file__), 'files')
    
    def _vocabulary(self):
        words_file = open(os.path.join(
            self._files_folder,
    ...
    def test_vocabulary_martin_mode(self):
        ...
        self._test_against_expected_output(
            ...
            open(os.path.join(self._files_folder, 'porter_martin_output.txt'))
                .read()
                .splitlines()
        )
    ...
    def test_vocabulary_nltk_mode(self):
        self._test_against_expected_output(
            ...
            open(os.path.join(self._files_folder, 'porter_nltk_output.txt'))
                .read()
                .splitlines()
        )
    ...
    def test_vocabulary_original_mode(self):
        ...
        self._test_against_expected_output(
            ...
            open(os.path.join(self._files_folder, 'porter_original_output.txt'))
                .read()
                .splitlines()
        )